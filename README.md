...
- **UI:** Lazy.nvim, macOS-aware light/dark themes, notifications, mini.statusline, winbar with an unsaved-change indicator, hidden-by-default line numbers with a command-palette toggle, and prose wrapping.
